...
ENDPOINT_PERMISSIONS = {
    ...
    "behavior.taxonomy": "behavior.configure",
    "behavior.delete_category": "behavior.configure",
    "behavior.subcategories": "behavior.configure",
    "behavior.delete_subcategory": "behavior.configure",
    "behavior.actions": "behavior.configure",
    "behavior.delete_action": "behavior.configure",
    "behavior.add_action_choice": "behavior.configure",
    "behavior.delete_action_choice": "behavior.configure",
    "behavior.attendance": "behavior.record",
    "behavior.void_attendance": "behavior.void",
    "behavior.restore_attendance": "behavior.void",
    "behavior.delete_attendance": "behavior.void",
    "behavior.update_attendance_status": "behavior.configure",
    "behavior.toggle_attendance_status": "behavior.configure",
    "behavior.update_attendance_scoring": "behavior.configure",
